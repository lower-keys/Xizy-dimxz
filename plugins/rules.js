...
let handler = async (m, { conn }) => conn.send3ButtonImg(m.chat, await (await fetch(global.takina)).buffer(),`
*Rules Bot*:
...
`.trim(), 'Rules By Dimxzz', '⋮☰ Menu', '.menu', 'Owner', '.owner', 'Donasi', '.donasi', m, {
    quoted: m,
    contextInfo: {
        externalAdReply: {
            title: 'Xizy_MD',
            ...
            mediaType: 2,
          thumbnail: await (await fetch('https://i.postimg.cc/8zCXVkyY/ce6ffeea35742410166301aede74af0d.jpg')).buffer(),
